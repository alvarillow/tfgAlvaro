...
<head>
    ...
    <title>Tienda de alvaro ibañez ramos</title>
...
<body>
		...
		<header>
			...
			<li class="nav-item">
				<a id="link" class="nav-link" href="../registro.html">Registro</a>
			</li>
			</ul>
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item <?php echo ($i == 0) ? 'active' : '';?>">
								<img src="<?php echo $fila['Imagen'];?>" alt="Plataforma" style="width:100%; height:100%;">
							</div>
							<?php
									$i++;
								}
				...
				<div class="container">
					...
					<div id="myCarousel2" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							?>
							<div class="item <?php echo ($i == 0) ? 'active' : '';?>">
								<img src="<?php echo $fila['Imagen'];?>" alt="Videojuego" style="width:100%; height:100%;">
							</div>
							<?php
									$i++;
								}
