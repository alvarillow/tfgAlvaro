...
<body>
    ...
    <form action="insertarPP.php" method="POST" enctype="multipart/form-data">

        <label>Marca</label><br>
        <input type="text" class="" name="Marca"><br>
        <label>Nombre</label><br>
        <input type="text" class="" name="Nombre"><br>
        <label>Descripcion</label><br>
        <input type="text" class="" name="Descripcion"><br>
        <label>Stock</label><br>
        <input type="number" class="" name="Stock"><br>
